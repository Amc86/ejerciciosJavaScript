...
const filtroRpg = videogames.filter(function(element){
    return element.genders.includes('RPG');
});

const totalScore = videogames.reduce((accumulator, videogames) => accumulator + videogames.score, 0);
const mediaScore = totalScore/videogames.length;

console.log(filtroRpg);
